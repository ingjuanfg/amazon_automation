...
public class AmazonPage {
    public static final Target INPUT_FIND = Target.the("Input to Find Articles").located(By.name("Buscar"));
    public static final Target BUTTON_FIND = Target.the("Button to Find Articles").located(By.name("Ir"));
