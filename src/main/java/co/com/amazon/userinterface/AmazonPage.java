...
public class AmazonPage {
    ...
    public static final Target BUTTON_ADD_TO_CAR = Target.the("Button add to cart").located(By.name("Add to Cart"));
    public static final Target BUTTON_CAR = Target.the("Button car").located(By.name("Proceed to checkout (1 item)"));
}